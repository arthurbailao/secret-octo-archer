...
Percebe-se que para uma mesma cena, a variação da resolução do vídeo não afeta de forma siginificativa o percentual de acerto, mostrando que vídeos de alta resolução não trazem vantagens nesse tipo de aplicação. Já a mudança da cena alterou o resultado. Nas amostras do tráfego no sentido centro o percentual de acerto foi superior a 95\%, enquando que as imagens do outro sentido não ultrapassaram os 90\%. 

Analisando as imagens dos dois sentidos %fallar que uma eh pior pq tem mais caminhao e onibus

Portanto, as características de uma cena, tais como o posicionamento 

As amostras do tráfego sentido centro obtiveram  
