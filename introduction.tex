...
\begin{itemize}
  ...
  \item Capítulo \ref{cha:metodologia} apresenta a metodologia para contagem volumétrica automática de veículos. As técnicas utilizadas, a sequência de operações, as imagens de processamento, as condições de captura e a estrutura do software são mostrados e explicados.
  \item Capítulo \ref{cha:testes_e_resultados} apresenta os resultados e a validação das contagens. Além disso, uma análise comparativa entre os resultados obtidos pelas imagens fornecidas pela BHTRANS e capturadas por uma câmera doméstica.
