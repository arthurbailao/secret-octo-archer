...
Atualmente existem diversas tecnologias de sensores capazes de efetuar a detecção de veículos \citep{minnesota1997field}. A Tabela \ref{fig:tabela_vantagens_desvantagens} lista grande parte delas, apresentando vantagens e desvantagens para cada uma \citep{aguiar2008thesis}. Nas subseções a seguir alguns sensores que utilizam essas tecnologias são detalhados.

\begin{figure}[ht]
  \begin{center}
    \includegraphics[scale=0.8]{imgs/tabela_vantagens_desvantagens.png}
  \end{center}
  \caption{Vantagens e desvantagens de tecnologias detectoras de veículos \citep{aguiar2008thesis}.}
  \label{fig:tabela_vantagens_desvantagens}
\end{figure}
...
% \toprule
% \multicolumn{1}{l}{\textbf{Time (s)}} & \multicolumn{1}{l}{\textbf{Triple chosen}} & \multicolumn{1}{l}{\textbf{Other feasible triples}} \\
% \midrule
% \endfirsthead
...
% \begin{table}[ht]
%   \caption{Vantagens e desvantagens de tecnologias detectoras de veículos.}
%   \label{tab:tecnologias_vantagens_desvantagens}
%   \begin{center}
%     \begin{tabularx}{\textwidth}{XXX}
%     \toprule
%     \textbf{Tecnologia} & \textbf{Vantagens} & \textbf{Desvantagens} \\
%     \midrule
