...
O método proposto foi implementado em forma de aplicativo na linguagem Java, utilizando a biblioteca de processamento de imagens JavaCV, que utiliza a maior parte das funções da OpenCV \citep{opencv_library}.
...
\begin{table}[ht]
  ...
  \begin{center}
    ...
    \hline
    Amostra & \% acerto & Duração do vídeo & Tempo celular & Tempo \textit{laptop}\\
    \hline
