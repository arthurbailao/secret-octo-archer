...
\begin{figure}[ht]
  ...
  \end{center}
  \caption{Diagrama de classe do \textit{software}.}
  \label{fig:uml}
\end{figure}
...
Com intuito de melhor avaliar a qualidade do método proposto neste trabalho, utiliza-se o índice Kappa para tal. O nível de exatidão obtido pode ser classificado conforme a Tabela \ref{tab:indice_kappa}, seguindo o estabelecido por \citeauthor{landis1977measurement} \citep{landis1977measurement}.
