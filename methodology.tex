...
% Para evitar o vies estatistico na montagem da matriz de confusao ao caracterizar as quatro possibilidades establece-se uma janela de tempo baseada no tempo médio em que um veiculo leva para percorrer toda a cena, dada uma determinada condição de tráfego. A contagem pura e simples, sem considerar esta janela de tempo, levaria à não consideração dos eventos VN.
